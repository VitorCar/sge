...
from django.contrib.auth.mixins import LoginRequiredMixin, PermissionRequiredMixin # Tem que esta logado para acessar as urls | permissão para usuarios 
...
class SupplierRetriveUpdateDestroyApiView(RetrieveUpdateDestroyAPIView):
    queryset = Supplier.objects.all()
    serializer_class = SupplierSerializers
